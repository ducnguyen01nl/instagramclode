    ...
    <View style={{width:'100%',height:'100%',backgroundColor:'white'}} >
      ...
      <View style={{padding:10}}>
        ...
        <View style={{paddingVertical:10}}>
            ...
            <TextInput placeholder="accountName" defaultValue={accountName} style={{fontSize:16,borderBottomWidth:1,borderColor:'#CDCDCD'}} />
        </View>
        <View style={{paddingVertical:10}}>
        ...
        <View>
        <Text style={{marginVertical:10,padding:10,color:'#3493D9',borderTopWidth:1,borderBottomWidth:1,borderColor:'#EFEFEF'}}>Switch to Professional account</Text>
            <Text style={{marginVertical:10,padding:10,color:'#3493D9',borderTopWidth:1,borderBottomWidth:1,borderColor:'#EFEFEF'}}>Persnol infomation setting</Text>
        </View>

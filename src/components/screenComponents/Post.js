    ...
    const postInfo = [
        {
            ...
            postPersonImage: require('../../storage/images/img1.jpg'),
                    ...
                    >
                        ...
                        <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingHorizontal:12,paddingVertical:15}}>
                            <View style={{flexDirection:'row',alignItems:'center'}}>
                                ...
                                <TouchableOpacity>
                                    <Feather name="navigation" style={{fontSize:20,paddingRight:10}} />
                                </TouchableOpacity>
                            </View>
                        ...
                        <View style={{paddingHorizontal:15}}>
                            ...
                            <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                                ...
                                <View style={{flexDirection:'row', alignItems:'center'}}>
                                    ...
                                    <Entypo name='emoji-sad' style={{fontSize:15,color:'pink',marginRight:10}} />
                                    <Entypo name='emoji-neutral' style={{fontSize:15,color:'red'}} />
                                </View>
                            </View>
                        </View>
